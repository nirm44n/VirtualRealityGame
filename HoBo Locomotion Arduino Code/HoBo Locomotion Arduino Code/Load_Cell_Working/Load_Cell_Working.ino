...
// HX711.DOUT  - pin 10
// HX711.PD_SCK - pin 11
HX711 scale(10, 11); // parameter "gain" is ommited; the default value 128 is used by the  library  library*/</p><p>/
void setup() 
{
  Serial.begin(38400);
...
// print the average of 5 readings from the ADC minus tare weight (not set) divided by the SCALE parameter (not set yet) </p><p>  
